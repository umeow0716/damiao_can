...
class DamiaoCAN:
    ...
    def query_param_one(self, index: int, rid: int) -> None:
        ...
    def recv_all(self, timeout_us: int = 500) -> int:
        ...
    def refresh_all(self) -> None:
        ...
...
class DamiaoCANGroup:
    ...
    def recv_all(self, timeout_us: int = 500) -> list[DamiaoCANRecvResult]:
        ...
